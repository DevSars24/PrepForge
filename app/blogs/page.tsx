...
export default async function BlogsPage({ searchParams }: PageProps) {
    ...
    // Database not connected — use empty array for now
    const blogs: any[] = [];
            ...
            <main className="max-w-7xl mx-auto px-4 md:px-6 pt-32 md:pt-40 pb-20 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-6 animate-fade-in-up">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
                        JEE &amp; NEET resources <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400">handpicked by toppers</span>.
                    </h1>
                    
                    <p className="text-zinc-400 text-lg md:text-xl">
                        Explore curated notes, important topics, strategy articles, and tips from IIT &amp; AIIMS alumni.
                    </p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        {blogs.length === 0 && (
                            <div className="col-span-full py-32 text-center border border-dashed border-white/10 rounded-[32px] bg-[#16133A]/30">
                                ...
                                <p className="text-indigo-300 font-bold text-lg mb-2">Resources coming soon!</p>
                                <p className="text-zinc-500 text-sm">JEE &amp; NEET articles, notes and topper tips will be published here soon.</p>
                            </div>
                        )}
                    </div>
                </div>
