    ...
    return (
        <div className="min-h-screen bg-[#0B0A1E] text-white">
            <div className="max-w-2xl mx-auto px-4 py-12">
                ...
                <p className="text-zinc-500 mb-6">Create a live session for aspirants to join</p>

                {/* DB Notice */}
                <div className="mb-8 flex items-start gap-3 px-5 py-4 rounded-xl bg-amber-500/10 border border-amber-500/25 text-amber-400 text-sm font-semibold">
                    <Loader2 size={16} className="flex-shrink-0 mt-0.5" />
                    <div>
                        <p className="font-bold mb-1">Database not connected yet</p>
                        <p className="text-amber-400/70 text-xs font-normal">
                            Connect NeonDB (add DATABASE_URL to .env) to enable session creation. The form below is ready — just waiting for the database!
                        </p>
                    </div>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6 opacity-60 pointer-events-none select-none">
                    {/* Title */}
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. JEE Physics — Mechanics Masterclass"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="What will the mentor cover? Who is the mentor?"
                            rows={4}
                    ...
                    <Button
                        type="submit"
                        disabled
                        className="w-full py-4 bg-purple-600/40 cursor-not-allowed text-white/50 font-bold rounded-xl"
                    >
                        Schedule Session (DB needed)
                    </Button>
                </form>
            </div>
        </div>
